...
// This file is copied verbatim from https://raw.githubusercontent.com/operator-framework/helm-operator-plugins/main/pkg/client/restclientgetter.go
// The only changes are:
// - the branch in ToRESTConfig that allows switching to a fixed behaviour.
// - the following line, from "package client" to "package main".
package main
